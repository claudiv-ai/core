 ...
 */
export function resolveScope(manifest, scopePath) {
 ...
 */
export async function assembleContext(change, scopePath, manifest, registry, projectRoot) {
...
// ─── Prompt Assembly ────────────────────────────────────────────
function buildPromptString(ctx) {
    const sections = [];
...
// ─── Helpers ────────────────────────────────────────────────────
function formatChangeAsTarget(change) {
    const parts = [];
...
function extractLines(content, lineSpec) {
...
function extractKeys(content, keysSpec) {
